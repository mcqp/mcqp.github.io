...
const config = {
  title: 'MCQP',
  tagline: 'The .mcq file interpreter and a CLI tool for sending messages/polls to Telegram.',
  ...
  organizationName: 'MCQP', // Usually your GitHub org/user name.
  projectName: 'mcqp.github.io', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        style: 'dark',
        copyright: `Copyright © ${new Date().getFullYear()} MCQP Project. Built with Docusaurus.`,
      },
      prism: {
